...
public static class TestConstants
{
    ...
    public const string ChannelName = "Test Channel";
    public const string UploadsPlaylistId = "TestUploadsPlaylistId";
    public const string UserId = "test-user-id";
    public const string PlaylistId = "playlist-id";
    public const string TargetVideoId = "target-video-id";
